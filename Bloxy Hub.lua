...
-- SISTEMA DISCORD NOTIFICACIÓN
DiscordBtn.MouseButton1Click:Connect(function()
    if setclipboard then
        setclipboard("https://discord.gg/fQF8BX7rbz")
    elseif toclipboard then
        toclipboard("https://discord.gg/fQF8BX7rbz")
    end
...
local function createScriptButton(text, parent, exactId, isInfinityYield)
    ...
    if exactId then
        ...
        padding.PaddingLeft = UDim.new(0, 15) -- Damos un margen limpio a la izquierda para el texto
        
        local icon = Instance.new("ImageLabel", btn)
        icon.Name = "BtnIcon"
        
        -- Anclamos el icono al borde derecho absoluto y lo centramos verticalmente
        icon.AnchorPoint = Vector2.new(1, 0.5)
        
        if isInfinityYield then
            icon.Size = UDim2.new(0, 65, 0, 32) 
            icon.Position = UDim2.new(1, 60, 0.5, 0) -- -10 píxeles de margen desde la derecha
            icon.ScaleType = Enum.ScaleType.Stretch
            padding.PaddingRight = UDim.new(0, 85) -- Protegemos el área derecha para que el texto no se monte
        else
            icon.Size = UDim2.new(0, 65, 0, 37) 
            icon.Position = UDim2.new(1, 30, 0.5, 0) -- -10 píxeles de margen desde la derecha
            icon.ScaleType = Enum.ScaleType.Fit
            padding.PaddingRight = UDim.new(0, 52) -- Protegemos el área derecha
        end
...
-- Espacios en los nombres eliminados para que queden alineados parejos
...
-- Línea blanca delgada FIJA sin símbolos
local SidebarLineBtn = Instance.new("TextButton", MainFrame)
...
SidebarLineBtn.Text = ""
SidebarLineBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
SidebarLineBtn.TextTransparency = 1
SidebarLineBtn.Font = Enum.Font.GothamBold
SidebarLineBtn.TextSize = 12
...
-------------------------------------------------------------------------
-- LÓGICA DE RATÓN GLOBAL (Evita cierres accidentales al 100%)
-------------------------------------------------------------------------
...
local function isMouseInSidebar()
    ...
    -- SOLUCIÓN: Zona que abarca TODO el lado izquierdo del menú principal
...
function toggleUI(show)
    ...
    TweenService:Create(SidebarLineBtn, fadeTweenInfo, {TextTransparency = t1, BackgroundTransparency = show and 0.8 or 1}):Play()
...
ToggleTagsBtn.MouseButton1Click:Connect(function()
    ...
    if _G.TagsEnabled then
        ...
        pcall(function() loadstring(game:HttpGet("https://raw.githubusercontent.com/Cooprince593/Script-hub/refs/heads/main/a.lua"))() end)
    else
...
Script1Btn.MouseButton1Click:Connect(function() executeScript("https://raw.githubusercontent.com/Cooprince593/Script-hub/refs/heads/main/Bloxy-MM2.lua?token=GHSAT0AAAAAAD2WYIB5HNNDATG43CU3LUQK2PLJNDQ") end)
Script2Btn.MouseButton1Click:Connect(function() executeScript("https://raw.githubusercontent.com/Cooprince593/Script-hub/refs/heads/main/Bloxy%20-%20emote.lua?token=GHSAT0AAAAAAD2WYIB5QOMNTJXV6UMPOXFA2PLJMVQ") end)
Script3Btn.MouseButton1Click:Connect(function() executeScript("https://raw.githubusercontent.com/Cooprince593/Script-hub/refs/heads/main/BLOXY-RV.lua?token=GHSAT0AAAAAAD2WYIB5Q53Y4TJOSA3UOB5I2PLJMXA") end)
...
task.spawn(function()
    ...
    ShowToastNotification("BLOXY HUB - ESP", "¿Deseas activar las etiquetas visuales para identificar a tus amigos en la partida?", "Activar ESP", "No, gracias", function(result)
        if result then
            ...
            pcall(function() loadstring(game:HttpGet("https://raw.githubusercontent.com/Cooprince593/Script-hub/refs/heads/main/tags.lua?token=GHSAT0AAAAAAD2WYIB4NMN5FATY53VEBJPO2PLJNRQ"))() end)
        else
            _G.TagsEnabled = false
